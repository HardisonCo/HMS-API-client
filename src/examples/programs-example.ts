...
import { hmsApiClient, ProgramData, ProgramStatus, ProgramFeedback } from '../api';
 ...
 */
export async function getFeaturedProgramsExample(): Promise<ProgramData[]> {
  try {
 ...
 */
export async function getRecentProgramsExample(): Promise<ProgramData[]> {
  try {
 ...
 */
export async function getProgramExample(programId: number): Promise<ProgramData | null> {
  try {
 ...
 */
export async function getProgramFeedbackExample(programId: number): Promise<ProgramFeedback[]> {
  try {
 ...
 */
export async function searchProgramsExample(query: string, categoryId?: number): Promise<ProgramData[]> {
  try {
 ...
 */
export async function toggleBookmarkExample(programId: number): Promise<boolean> {
  try {
 ...
 */
export async function getBookmarksExample(): Promise<ProgramData[]> {
  try {
 ...
 */
export async function getProgramCategoriesExample(): Promise<void> {
  try {
 ...
 */
export async function getUserProgramsExample(userId: number): Promise<ProgramData[]> {
  try {
 ...
 */
export async function getUserFeaturedProgramsExample(userId: number): Promise<ProgramData[]> {
  try {
